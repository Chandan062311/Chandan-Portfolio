      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={onClose}
              className="absolute right-4 top-4 z-10 flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-[color:var(--color-surface-strong)] text-[color:var(--color-muted)] transition-colors hover:bg-white/10 hover:text-[color:var(--color-text)]"
              aria-label="Close"
            >
